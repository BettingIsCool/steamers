...
with col_book1:
    selected_book1 = st.selectbox(label='Bookie 1', options=sorted(list(BOOKS)), key='book1_key', on_change=db.change_book1, help='Deeplinks for your preferred bookmaker can be included in every alert. One click will take you to the respective market meaning a highly efficient and hassle-free bet placement.')
with col_book2:
    selected_book2 = st.selectbox(label='Bookie 2', options=sorted(list(BOOKS)), key='book2_key', on_change=db.change_book2, help='Deeplinks for your preferred bookmaker can be included in every alert. One click will take you to the respective market meaning a highly efficient and hassle-free bet placement.')
with col_book3:
    selected_book3 = st.selectbox(label='Bookie 3', options=sorted(list(BOOKS)), key='book3_key', on_change=db.change_book3, help='Deeplinks for your preferred bookmaker can be included in every alert. One click will take you to the respective market meaning a highly efficient and hassle-free bet placement.')
