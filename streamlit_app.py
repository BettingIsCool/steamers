...
if st.session_state.session_id == toolkit.get_active_session(st.session_state.user_id):
    ...
    st.session_state.default_tag = st.sidebar.slider("Select minimum value threshold", min_value=2.5, max_value=100, step=0.5, value=st.session_state.default_minval, on_change=db.change_user_minval, args=(username, placeholder1), key='default_minval_key')
