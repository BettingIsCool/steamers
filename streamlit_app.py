...
selected_need_book = st.radio(label='Need Bookie', options=['yes', 'no'], index=1, key='need_book_key', on_change=db.change_need_book, args=(username,), help='Choose YES if you only want to receive messages that includes a link of at least one of your selected bookmakers. Select NO if you want to receive all alerts (regardless of whether a link is included or not).')
