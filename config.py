...
SPORTS = list()
SPORTS.append('Alpine Skiing')
SPORTS.append('Archery')
SPORTS.append('Athletics')
SPORTS.append('Aussie Rules')
SPORTS.append('Badminton')
SPORTS.append('Bandy')
SPORTS.append('Baseball')
SPORTS.append('Basketball')
SPORTS.append('Beach Volleyball')
SPORTS.append('Biathlon')
SPORTS.append('Bobsleigh')
SPORTS.append('Boxing')
SPORTS.append('Chess')
SPORTS.append('Cricket')
SPORTS.append('Cross Country')
SPORTS.append('Crossfit')
SPORTS.append('Curling')
SPORTS.append('Cycling')
SPORTS.append('Darts')
SPORTS.append('Drone Racing')
SPORTS.append('E Sports')
SPORTS.append('Entertainment')
SPORTS.append('Field Hockey')
SPORTS.append('Figure Skating')
SPORTS.append('Floorball')
SPORTS.append('Football')
SPORTS.append('Formula 1')
SPORTS.append('Freestyle Skiing')
SPORTS.append('Futsal')
SPORTS.append('Golf')
SPORTS.append('Handball')
SPORTS.append('Hockey')
SPORTS.append('Horse Racing Specials')
SPORTS.append('Lacrosse')
SPORTS.append('Luge')
SPORTS.append('Mixed Martial Arts')
SPORTS.append('Motorsport')
SPORTS.append('Nordic Combined')
SPORTS.append('Olympics')
SPORTS.append('Other Sports')
SPORTS.append('Padel Tennis')
SPORTS.append('Pickleball')
SPORTS.append('Poker')
SPORTS.append('Politics')
SPORTS.append('Rugby League')
SPORTS.append('Rugby Union')
SPORTS.append('Short Track')
SPORTS.append('Simulated Games')
SPORTS.append('Skeleton')
SPORTS.append('Ski Jumping')
SPORTS.append('Slap Fighting')
SPORTS.append('Snooker')
SPORTS.append('Snow Boarding')
SPORTS.append('Soccer')
SPORTS.append('Softball')
SPORTS.append('Speed Skating')
...
BOOKS.add('Bitz')
BOOKS.add('Blaze_BR')
BOOKS.add('BloodMoon_CO')
BOOKS.add('Bons')
BOOKS.add('CasinoX')
BOOKS.add('Casinozer')
BOOKS.add('Casinozer_EU')
BOOKS.add('Fortunejack')
BOOKS.add('JetBet_BR')
BOOKS.add('JonBet_BR')
BOOKS.add('Joycasino')
BOOKS.add('KingpandaBet_BR')
BOOKS.add('LuckyBlock')
BOOKS.add('LuckyBlock_TOP')
BOOKS.add('Opabet')
BOOKS.add('PinBet')
BOOKS.add('Pokerdom')
BOOKS.add('PuskasBet_BR')
BOOKS.add('RajaBets')
BOOKS.add('Riobet')
BOOKS.add('Rivalry')
BOOKS.add('Rollbit')
BOOKS.add('RooBet')
BOOKS.add('SlotsSafari_CO')
BOOKS.add('Solcasino')
BOOKS.add('Yonibet')
...
BOOKS.add('Giocodigitale_IT')
BOOKS.add('Oddset_DE')
BOOKS.add('Sportingbet')
BOOKS.add('Sportingbet_BR')
BOOKS.add('Sportingbet_DE')
BOOKS.add('Sportingbet_GR')
