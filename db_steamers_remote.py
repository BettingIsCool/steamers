...
def append_user(data: dict):
    ...
    with conn.session as session:
        session.execute(text(query), params=dict(username=data['username'], default_odds_display='Decimal', default_timezone='Europe/London', default_minval=0.025, default_minodds=1, default_maxodds=1000, default_book1='bet365', default_book2='bwin', default_book3='unibet', default_book4='winamax.es', default_book5='williamhill'))
        session.commit()
